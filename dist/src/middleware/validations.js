...
exports.addressValidation = exports.loginValidation = exports.productValidator = exports.newUserValidate = void 0;
...
const newUserValidate = (req, res, next) => {
    ...
    const userSchema = joi_1.default.object({
        ...
        number: joi_1.default.number().integer().min(Math.pow(10, 9)).max(Math.pow(10, 10) - 1).required(),
